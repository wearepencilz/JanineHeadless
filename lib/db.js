...
const TAXONOMY_DEFAULTS = {
  ...
  contentBlockTypes: [
    { id: 'hero', label: 'Hero', value: 'hero', description: 'Large hero image/video section', sortOrder: 1, archived: false },
    { id: 'text', label: 'Text', value: 'text', description: 'Text content block', sortOrder: 2, archived: false },
    { id: 'image-gallery', label: 'Image Gallery', value: 'image-gallery', description: 'Multiple images in a gallery', sortOrder: 3, archived: false },
    { id: 'product-showcase', label: 'Product Showcase', value: 'product-showcase', description: 'Featured products section', sortOrder: 4, archived: false },
  ],
}
