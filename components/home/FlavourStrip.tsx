...
function LaunchCard({ launch, flavourMap }: { launch: any; flavourMap: Record<string, any> }) {
  ...
  return (
    <Link href={`/launches/${launch.slug}`} className="flex-none w-[178px] group">
      ...
      <div className="flex flex-col gap-[6px] text-[#333112] text-[12px] tracking-[0.24px] uppercase leading-none" style={{ fontFamily: 'var(--font-neue-montreal)', fontWeight: 500 }}>
